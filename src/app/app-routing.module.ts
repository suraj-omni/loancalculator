...
import {LoancalculatorComponent} from './loan/loancalculator/loancalculator.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'loans/loancalculator', component: LoancalculatorComponent, data: {extraParameter: 'loansmenu'}},
